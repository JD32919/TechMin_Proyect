...
<head>
    ...
    <title>Admin panel/Products-TechMin</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/styles_dashboard_myModal_offerst.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/stylesmessage.css') }}">
        ...
        <div class="menu-container">
            <ul class="menu">
                ...
                <li class="menu-item menu-item-static active">
                    <a href="{{ route('graficas') }}" class="menu-link">
                ...
                <li class="menu-item menu-item-static">
                    <a href="{{ route('orders') }}" onclick="openModal3()" class="menu-link">
                ...
                <li class="menu-item menu-item-static">
                    <a href=" #"  onclick="openModal2()"   class="menu-link">
                        <svg width="41" height="41" viewBox="0 0 31 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
...
<!-- Fin del menu lateral-->
    ...
    <div id="image-category" class="image-category">
...
<main id="main">
    ...
    <!-- Cards section  -->
    <div id="carousel-section" class="Carousel-section">
    ...
    <script src="{{ asset('assets/js/dashboard_myModal_offerst.js') }}"></script>
    ...
    <script src="{{ asset('assets/js/guardar_producto.js') }}"></script>
    <script src="{{ asset('assets/js/guardar_producto_category.js') }}"></script>
